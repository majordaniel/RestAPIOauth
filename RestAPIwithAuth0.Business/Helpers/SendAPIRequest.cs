...
namespace RestAPIwithAuth0.Business.Helpers
{
  public  class SendAPIRequest
    {
        public static async Task<Dictionary<string, string>> SendHttpRequest(string baseUrl, string requestUri, string action, Dictionary<string, string> headers, string requestBody = null)
        {
